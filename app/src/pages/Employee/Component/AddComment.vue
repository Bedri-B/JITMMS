<template>
  ...
  >
    <div
      class="p-3 h-full w-full overflow-auto flex flex-col place-items-center"
    >
      ...
      <div v-if="!loading" class="mt-5">
        <button
          class="inline-block px-6 py-2.5 bg-blue-500 text-white font-medium text-lg leading-tight uppercase rounded shadow-md hover:bg-blue-600 hover:shadow-lg focus:bg-blue-600 active:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out"
          type="button_"
          @click="submit"
        >
          Submit
